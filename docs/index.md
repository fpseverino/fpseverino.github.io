...
- 🌱 At university, I worked in C, Assembly, Java, SQL, MATLAB, Python and VHDL. My exam projects include:
    ...
    - A [smart greenhouse simulation](https://github.com/fpseverino/progetto-reti-calc) written in MATLAB/Simulink, using the TrueTime simulator, which has been published on the [Bulletin of the UNESCO chair “Distance education in engineering” of the SUAI](/assets/ESPC-2024.pdf).
